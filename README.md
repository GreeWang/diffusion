...
我做这个项目的出发点比较直接：
很多扩散模型相关项目会展示生成效果，但如果真的落到推理阶段，实际更关心的问题通常是：
...
所以这个项目的重点不在“生成了什么图”，而在“这套推理流程跑起来表现怎么样”。

目前项目主要有两部分：

一个 benchmark 脚本，用来在统一条件下对比 baseline 和 HiDiffusion
一个 auto config 脚本，根据显存预算和目标分辨率给出一组较保守的推荐配置
目前包含的内容
1. Benchmark Runner
